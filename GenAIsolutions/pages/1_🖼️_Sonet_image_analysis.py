...
st.title("💬 📷 Conversational AI for Text and Image using Amazon Bedrock")
...
if (
    ...
    def download_image(file_name):
        ...
        href = f'<a href="data:image/png;base64,{base64_image}" download="{file_name}">Download {file_name}</a>'
    ...
    def main() -> None:
        ...
        image_files = ["force_question.png", "Solution_architecture.png", "Labreport.jpg"]
        
        # Display the available image files as a selectbox
        selected_file = st.selectbox("Select an image file to download", image_files)
        
        # Call the download_image function with the selected file
        download_image(selected_file)
